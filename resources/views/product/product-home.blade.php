@extends('layouts.app', ['page' => __('category Home'), 'pageSlug' => 'product'])
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{route('addProducts')}}" class="btn btn-sm btn-primary">Add Product</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow bg-dark text-light">
                                                    <a class="dropdown-item" onclick="confirm('Are uou sure do want to delete this')" href="{{route('productDelete',[$datum->id])}}">Delete</a>
                                                    <a class="dropdown-item" href="{{route('updateProduct',[$datum->id])}}">Edit</a>
                                                </div>
                                            </div>
                                        </td>
