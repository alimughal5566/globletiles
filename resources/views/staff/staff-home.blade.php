@extends('layouts.app', ['page' => __('user Home'), 'pageSlug' => 'user'])
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{route('addStaff')}}" class="btn btn-sm btn-primary">Add User</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow bg-dark text-light">
                                                    <a class="dropdown-item" href="{{route('staffDelete',[$datum->id])}}">Delete</a>
                                                    <a class="dropdown-item" href="{{route('staffEdit',[$datum->id])}}">Edit</a>
                                                </div>
                                            </div>
                                        </td>
