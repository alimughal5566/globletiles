@extends('layouts.app', ['page' => __('Company Home'), 'pageSlug' => 'company'])
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="card-title">Companies Home</h4>
                            </div>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow bg-dark text-light">
                                                    <a class="dropdown-item" href="{{route('companyDelete',[$datum->id])}}">Delete</a>
                                                    <a class="dropdown-item" href="{{route('companyEdit',[$datum->id])}}">Edit</a>
                                                </div>
                                            </div>
                                        </td>
